...
export const getPageTopApi = () => {
  return request.get<any>({ url: '/newsType/pageTop' })
}

// 分页列表查询
export const getPageListApi = (params: any) => {
  return request.get<any>({ url: '/newsType/pageList', params })
}

// 通过id查询
export const getPageListByIdApi = (params: any) => {
  return request.get<any>({ url: '/newsType/queryById', params })
}

// 添加
export const addDataListApi = (data: any) => {
  return request.post<any>({ url: '/newsType/add', data })
}

// 编辑
export const editDataListApi = (data: any) => {
  return request.put<any>({ url: '/newsType/edit', data })
}
