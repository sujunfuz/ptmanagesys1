...
import { ElTree, ElMessage, ElImage } from 'element-plus'
import { getGoodsListApi, getFactoryListApi } from '@/api/operationCenter/chartManagement'
...
const { tableRegister, tableState, tableMethods } = useTable({
  fetchDataApi: async () => {
    ...
    let res
    if (props.openType == 'relevancyId1') {
      res = await getGoodsListApi({
...
const crudSchemas1 = reactive<CrudSchema[]>([
  ...
  },
  {
    ...
    table: {
      slots: {
        default: (data: any) => {
          const image = data.row.thumbnailAddr
          return (
            <>
              <div class="flex">
          ...
          return (
            <>
              <div class="flex">
                ...
                <div style="width: 350px;" class="ml-10px">
