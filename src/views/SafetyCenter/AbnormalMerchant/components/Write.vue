...
<template>
  <div>
    <div class="flex-c color-#7A7A7A font-size-14px">
      <div class="text-right w-120px min-w-120px">{{ t('abnormalMerchant.sub2') }}:</div>
      <div class="ml-15px color-colorBlack">{{ currentRow.companyName || '-' }}</div>
    </div>
    <div class="flex-c mt-20px color-#7A7A7A font-size-14px">
      <div class="text-right w-120px min-w-120px">{{ t('abnormalMerchant.email') }}:</div>
      <div class="ml-15px color-colorBlack">{{ currentRow.applicantEmail || '-' }}</div>
    </div>
    <div class="flex-c mt-20px color-#7A7A7A font-size-14px">
      <div class="text-right w-120px min-w-120px">{{ t('abnormalMerchant.sub5') }}:</div>
      <div class="ml-15px color-colorBlack">{{ currentRow.applicantName || '-' }}</div>
    </div>
    <div class="flex-c mt-20px color-#7A7A7A font-size-14px">
      <div class="text-right w-120px min-w-120px">{{ t('abnormalMerchant.iphone') }}:</div>
      <div class="ml-15px color-colorBlack">{{ currentRow.applicantMobile || '-' }}</div>
    </div>
    <div class="flex-c mt-20px color-#7A7A7A font-size-14px">
      <div class="text-right w-120px min-w-120px">{{ t('abnormalMerchant.status1') }}:</div>
    ...
    <div class="flex justify-start mt-20px color-#7A7A7A font-size-14px">
      ...
      <div class="ml-15px">
        <div
          ...
          v-for="(item, key) in currentRow.merBehaviorList"
          :key="key"
          >{{ item.createTimeStr || '-' }}&nbsp;&nbsp;&nbsp;{{
            item.behavior || '-'
          }}&nbsp;&nbsp;&nbsp;{{ item.ip || '-' }}</div
