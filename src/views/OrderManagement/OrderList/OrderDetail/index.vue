<template>
  <div v-if="goodsInfo">
    ...
    <ContentWrap class="mt-20px">
      <div class="flex w-100% font-size-14px">
        <div class="w-25%">
        ...
        <div class="w-25%" v-if="goodsInfo.receiveInfo">
      ...
      >
        <!-- v-if="goodsInfo.logisticsInfo.items.length > 0" -->
        <div
          v-if="
            goodsInfo.logisticsInfo &&
            goodsInfo.logisticsInfo.items &&
            goodsInfo.logisticsInfo.items.length > 0
          "
    ...
    <ContentWrap class="mt-20px">
      ...
      <div class="mt-20px">
        ...
        <div class="h-88px flex-c w-100% justify-end">
          <div class="flex">
            <el-button @click="dialogVisible = true" v-if="goodsInfo.receiveInfo">{{
              t('orderList.more3')
            }}</el-button>
            <el-button
              @click="cancelOrder"
              v-hasPermi="'ordstorebatchorder:ordStoreBatchOrder:cancel'"
