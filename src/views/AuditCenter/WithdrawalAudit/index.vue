<template>
  <ContentWrap>
    <Search
      v-hasPermi="'settlement:finSettlement:settlePageList'"
      :schema="searchSchema"
...
import { getPageListApi, getPageTopApi } from '@/api/withdrawalAudit/index'
    ...
    slots: {
      default: (data) => {
        return (
          <span
            class="clickAction"
            v-hasPermi="settlement:finSettlement:settleDetail"
            onClick={() => {
              push({
                path: '/auditcenter/withdrawalAudit/withDrawalDetail',
