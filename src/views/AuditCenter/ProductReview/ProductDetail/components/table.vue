...
const getNewTableData = () => {
  ...
  columns.value.forEach((item, index) => {
    if (item.field == 'cost' || item.field == 'price' || item.field == 'inventory') {
      columns.value[index].slots = {
        default: (data) => {
          ...
          //       <span>
          //         <ElInput style="width: 60px;" v-model={data.row[item.field]} />
          //         <ElButton
          //           type="primary"
          //           class="ml-5px"
          ...
          //   )
          // } else {
          //   if (openInventoryMouse.value == index + ' ' + cellIndex) {
          //     return (
          //       <>
          //         <span>{inventory}</span>
          //         {/* <span class="colorfff bgcolorMainRed p-6px border-rd-40% ml-2">库存不足</span> */}
          //         <span
          //           onClick={() => editClick(index, cellIndex)}
          //           onMouseenter={() => mouseEnter(index, cellIndex)}
          //         >
          ...
          //           onMouseenter={() => mouseEnter(index, cellIndex)}
          //         >
          //           <Icon class="ml-1 invisible" icon="ep:edit" />
          //         </span>
          //       </>
          //     )
          //   }
